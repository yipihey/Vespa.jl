...
export CIC_ZOUT="1000,680,460,315,215,145,100,65,45,30,20" CIC_CHEM=1 CIC_CHEM_ENGINE=kernels CIC_CHEM_BACKEND=metal CIC_COMPTON_DRAG=1 CIC_TAG=_c32
LOG=reports/multicode/c32_arepo.log
