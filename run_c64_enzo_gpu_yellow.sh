...
export CIC_ZOUT="1000,680,460,315,215,145,100,65,45,30,20" CIC_CHEM=1 CIC_CHEM_ENGINE=kernels CIC_USE_GRACKLE=0 CIC_XSPEC=1 CIC_CELLCMP=0 CIC_COMPTON_DRAG=1 CIC_TAG=_c64g
LOG=reports/multicode/c64_enzo_gpu.log
