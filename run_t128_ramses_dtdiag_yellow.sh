...
export CIC_ZOUT="1000,680,460,315,215,145,100,65,45,30,20" CIC_CHEM=1 CIC_CHEM_ENGINE=kernels CIC_CHEM_BACKEND=cuda CIC_DUAL_ENERGY=1 CIC_COMPTON_DRAG=1 CIC_XSPEC=0 CIC_CELLCMP=0 CIC_TAG=_t128_dtdiag
export CIC_DTDIAG=1
LOG=reports/multicode/t128_ramses_dtdiag.log
