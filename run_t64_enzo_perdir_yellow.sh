...
export CIC_ZOUT="1000,680,460,315,215,145,100,65,45,30,20" CIC_CHEM=1 CIC_CHEM_ENGINE=kernels CIC_USE_GRACKLE=0 CIC_COMPTON_DRAG=1 CIC_XSPEC=0 CIC_CELLCMP=0 CIC_TAG=_t64_perdir
export CIC_PERDIR_CFL=1 CIC_DTDIAG=1
LOG=reports/multicode/t64_enzo_perdir.log
